...
internal class RosaryBeadList(Config cfg) : ItemList<RosaryBead>
{
    ...
    public RosaryBead RB510 { get; } = new RosaryBead(new RB510());
    public RosaryBead RB511 { get; } = new RosaryBead(new RB511());
    public RosaryBead RB512 { get; } = new RosaryBead(new RB512());
    public RosaryBead RB513 { get; } = new RosaryBead(new RB513());
    public RosaryBead RB514 { get; } = new RosaryBead(new RB514());
